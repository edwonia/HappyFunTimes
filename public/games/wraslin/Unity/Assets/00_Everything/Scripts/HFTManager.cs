...
public class HFTManager : MonoBehaviour {
    ...
    void Start () {
        ...
        options.gameId = "wraslin";
        options.controllerUrl = "http://localhost:8080/games/wraslin/index.html";
    ...
    void StartNewPlayer(object sender, PlayerConnectMessageArgs e) {
        ...
        Vector3 position = new Vector3(m_rand.Next(settings.areaWidth), 0, 0);
